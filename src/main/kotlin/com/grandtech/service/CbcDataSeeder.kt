    ...
    companion object {
        ...
        val SUBJECTS = listOf(
            Subject(
                ...
                symbol = "ENG",
                name = "English",
                description = "Reading, writing, and communication in the English language.",
            ...
            Subject(
                ...
                symbol = "KIS",
                name = "Kiswahili",
                description = "Reading, writing, and communication in the Kiswahili language.",
                type = SubjectType.LANGUAGE,
                periodsPerWeek = 4,
                maxPeriodsPerDay = 1,
            ),
            Subject(
                ...
                symbol = "MAT",
                name = "Mathematics",
                description = "Numbers, algebra, geometry, and logical problem-solving.",
            ...
            Subject(
                ...
                description = "Biology, chemistry, and physics concepts through practical inquiry.",
            ...
            Subject(
                ...
                description = "Design, construction, and basic technical drawing skills.",
            ...
            Subject(
                ...
                symbol = "SST",
                name = "Social Studies",
                description = "History, geography, civics, and environmental awareness.",
            ...
            Subject(
                ...
                description = "CRE, IRE, or HRE — moral values and spiritual development.",
            ...
            Subject(
                ...
                description = "Crop production, food science, and healthy living practices.",
            ...
            Subject(
                ...
                description = "Visual arts, music, drama, and physical education activities.",
            ...
            Subject(
                ...
                description = "Life skills, decision-making, self-awareness, and social responsibility.",
